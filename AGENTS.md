...
This document provides a comprehensive overview of the Cue project for AI assistants like Codex to understand the codebase, architecture, and implementation details.
...
This document should give you (Codex or any LLM) a complete understanding of the Cue codebase. For specific implementation details, refer to the actual code files mentioned above.
